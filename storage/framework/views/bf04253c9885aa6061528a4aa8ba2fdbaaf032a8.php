...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-xl-2 col-md-2">
            <div class="form-check form-switch ml-1">
                <input type="checkbox" class="form-check-input" id="login" name="footer"<?php echo e($page['login'] == 'on' ? 'checked' : ""); ?>/>
...
<?php /**PATH C:\xampp\htdocs\nitt erp\Modules/LandingPage\Resources/views/landingpage/menubar/edit.blade.php ENDPATH**/ ?>